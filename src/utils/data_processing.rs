...
pub fn compute_dais_variants(
    ...
    // Sort by protein, sample_id, and aa_variant_count --> have to sort by positional_reference_is to get Brisbane60 to be first in the list for BVIC
